              ...
              <div className="options">
                <div className="optionItem">
                  ...
                  <div className="optionsContainer">
                    ...
                    <span className="optionCounterNumber">{optionValues.adult}</span>
                    <button
                ...
                <div className="optionItem">
                  ...
                  <div className="optionsContainer">
                    ...
                    <span className="optionCounterNumber">{optionValues.children}</span>
                    <button
                ...
                <div className="optionItem">
                  ...
                  <div className="optionsContainer">
                    ...
                    <span className="optionCounterNumber">{optionValues.room}</span>
                    <button
